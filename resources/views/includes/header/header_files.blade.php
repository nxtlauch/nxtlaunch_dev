...
{{--Favicons--}}
{{--<link rel="apple-touch-icon" href="{{asset('public/pages/ico/60.png')}}">--}}
{{--<link rel="apple-touch-icon" sizes="76x76" href="{{asset('public/pages/ico/76.png')}}">--}}
{{--<link rel="apple-touch-icon" sizes="120x120" href="{{asset('public/pages/ico/120.png')}}">--}}
{{--<link rel="apple-touch-icon" sizes="152x152" href="{{asset('public/pages/ico/152.png')}}">--}}
