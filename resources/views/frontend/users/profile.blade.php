            ...
            <div class="content">
                <div class="plx__container">
                    ...
                    <span class="number seconds">21</span>s
                                                ...
                                                @empty
                                                    <h4 class="text-center">{{$user->id==Auth::id()?'You':$user->name}} didn't follow any post yet</h4>
                                                @endforelse
                                            </div>
                                            <div id="followingUsers" class="plx__tabs-item">
                                                <ul class="brand-list">
                                                    ...
                                                    @empty
                                                        <h4 class="text-center">{{$user->id==Auth::id()?'You':$user->name}} didn't follow any user yet</h4>
                                                    @endforelse
                                                </ul>
                                            </div>
                                        </div>
