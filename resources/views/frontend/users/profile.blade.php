                ...
                <div class="plx__container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-12 d-flex flex-column" id="postrender">
                                        ...
                                        <div class="profile-area">
                                            ...
                                            <ul class="plx__tabs">
                                                <li style="width: 50%;" class="tab-item"><a href="#userPosts"
                                                                                            class="active"><i
                                                                class="pg-unordered_list"></i> Posts</a></li>
                                                <li style="width: 50%;" class="tab-item"><a href="#likedPosts"><i
                                                                class="fa fa-heart-o"></i> Liked Posts</a></li>
                    ...
                    <span class="number seconds">21</span>s
                     ...
                     <span class="number seconds">21</span>s
                                            ...
                                            <div id="likedPosts" class="plx__tabs-item">
                                                <ul class="plx__tabs-alt forFollowing clearfix">
                                                    <li class="tab-item"><a class="active" href="#likedLaunches">Launches</a>
                                                    </li>
                                                    <li class="tab-item"><a href="#likedLaunched">Launched</a></li>
                                                </ul>
                                                <div id="likedLaunches"
                                                     class="forFollowingContent tab-content active">
                                                    @forelse($user->likes->where('post.expire_date','>',Carbon\Carbon::now()->toDateTimeString())->sortByDesc('id') as $post)
                     ...
                     <span class="number seconds">21</span>s
                                                    ...
                                                    @empty
                                                        <h4 class="text-center">{{$user->id==Auth::id()?'You':$user->name}}
                                                            didn't like any post yet</h4>
                                                    @endforelse
                                                </div>
                                                <div id="likedLaunched" class="forFollowingContent tab-content">
                                                    {{--{{dd($user->followPosts->)}}--}}
                                                    @forelse($user->likes->where('post.expire_date','<',Carbon\Carbon::now()->toDateTimeString())->sortByDesc('id') as $post)
                                                        <div class="plx__post alt" id="post_id_{{$post->post->id}}">
                                                            <div class="ratio-4-3 plx__post-thumb"
                     ...
                     <span class="number seconds">21</span>s
                                                    ...
                                                    @empty
                                                        <h4 class="text-center">{{$user->id==Auth::id()?'Your':$user->name."'s"}}
                                                            liked any post doesn't launch yet</h4>
                                                    @endforelse
                                                </div>
                                            </div>
                                        </div>
