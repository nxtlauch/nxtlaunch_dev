        ...
        <div class="p-l-30 p-r-30 p-t-30 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
            ...
            <form id="form-login" class="p-t-15" method="post" role="form" action="{{route('pro.user.registration')}}">
                ...
                <div class="form-group{{ $errors->has('category_name') ? ' has-error' : '' }}">
                    ...
                    <ul class="business-type-list">
                        @foreach($categories as $category)
                            <li>
                                <label for="userCategory{{$category->id}}" class="business-type" data-toggle="tooltip"
                                       title="{{$category->name}}">
                ...
                <div class="form-group m-b-20{{ $errors->has('category_name') ? ' has-error' : '' }}">
                    ...
                    <textarea name="business_description" id="" rows="4" class="form-control" style="height: 100px"
                              required></textarea>
                ...
                <!-- END Form Control-->
                <button class="btn btn-block btn-primary btn-cons m-t-10 m-b-15" type="submit">Complete</button>
            </form>
            <!--END Login Form-->
        </div>
    </div>
