                                            ...
                                            <div class="form-inline m-b-15">
                                                <div class="form-group form-group-sm m-b-15 m-r-15">
                                                    ...
                                                    <select name="" id="" class="sortBy form-control form-control-sm">
                                                        <option value="#launchesClosest">Closest</option>
                                                        <option value="#launchesFurthest">Furthest</option>
                                                    </select>
                                                </div>
                                            </div>

                                            <div id="launchesClosest" class="short-items active">
{{--                                                @forelse($posts->where('post.expire_date','>',Carbon\Carbon::now()->toDateTimeString())->sortByDesc('id') as $post)--}}
                                                @forelse($posts->where('post.expire_date','>',Carbon\Carbon::now()->toDateTimeString())->sortBy('post.expire_date') as $post)
                                                    {{--{{dd($post->post)}}--}}
                                                            ...
                                                            <div class="plx__post-header">
                                                                ...
                                                                <div class="plx__meta-text">
                                                                    ...
                                                                    <div class="plx__time-countdown">
                                                                        ...
                                                                        <span title="{{\Carbon\Carbon::parse($post->post->expire_date)->format('M d, Y H:i')}}" data-toggle="tooltip"
                    ...
                    <span class="number seconds">21</span>s
                                                                ...
                                                                <div class="options">
                                                                    ...
                                                                    <ul class="options-list">
                                                                        <li><a href="javascript://" class="change_notification" data-post="{{@$post->post->id}}">Get Notification</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                            ...
                                            <div id="launchesFurthest" class="short-items">
                                                @forelse($posts->where('post.expire_date','>',Carbon\Carbon::now()->toDateTimeString())->sortByDesc('post.expire_date') as $post)
                                                    {{--{{dd($post->post)}}--}}
                                                    <div class="plx__post alt" id="post_id_{{$post->post->id}}">
                                                        <div class="ratio-4-3 plx__post-thumb"
                                                             style="background-image: url('{{asset('content-dir/posts/images/'.$post->post->image) }}')"></div>
                                                        <div class="plx__post-info">
                                                            <div class="plx__post-header">
                                                                ...
                                                                <div class="plx__meta-text">
                                                                    ...
                                                                    <div class="plx__time-countdown">
                                                                        @php($days=\Carbon\Carbon::parse($post->post->expire_date)->diffInDays())
                                                                        <span title="{{\Carbon\Carbon::parse($post->post->expire_date)->format('M d, Y H:i')}}"
                                                                              class="plx__countdown {{$days<7?'text-danger':($days<30?'text-warning':'text-success')}}"
                                                                              data-date-time="{{$post->post->expire_date}}">
                    <span class="number day">08</span>d :
                    <span class="number hour">14</span>h :
