            ...
            <div class="message clearfix">
                <div class="profile-img-wrapper m-t-5 inline">
                    <img class="col-top" width="30" height="30"
                         src="{{$message->message_from->userDetails->profile_picture?asset('content-dir/profile_picture/'.$message->message_to->userDetails->profile_picture):asset('public/frontend-assets/assets/img/profiles/avatar_small.jpg')}}"
                         alt="">
                </div>
